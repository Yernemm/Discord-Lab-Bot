//METADATA
const desc = "This command restarts the conversational AI of the bot."; //Short description of what the command does.
...
exports.run = (config, client, message, argsArr, argsTxt, extraData) => {
    ...
    //--------------------------------------------------------------------
    var msg = "Something went wrong..."; //Put response message to be logged here.
    //--------------------------------------------------------------------
